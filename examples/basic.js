...
db.query(
  "INSERT INTO users VALUES (1, 'John Doe', 'john@example.com', 30, true)",
);
db.query(
  "INSERT INTO users VALUES (2, 'Jane Smith', 'jane@example.com', 25, false)",
);
db.query(
  "INSERT INTO users VALUES (3, 'Bob Johnson', 'bob@example.com', 35, true)",
);
...
db.query(
  "INSERT INTO users (id, name, email, age) VALUES (4, 'Alice Brown', 'alice@example.com', 28)",
);
...
console.log(
  "    Schema for users:",
  JSON.stringify(db.getTableSchema("users").columns, null, 2),
);
